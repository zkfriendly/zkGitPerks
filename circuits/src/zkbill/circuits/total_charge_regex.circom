...
// regex: Your payment of $ [0-9]+ has been received
template TotalChargeRegex(msg_bytes) {
	...
	for (var i = 0; i < msg_bytes; i++) {
		...
		is_substr0[i][2] <== is_substr0[i][1] + states[i+1][37] * states[i+2][1];
