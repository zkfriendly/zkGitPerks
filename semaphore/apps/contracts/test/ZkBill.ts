...
import { GateKeeper, IERC20__factory, ZkBill, ZkBillVerifier } from "../build/typechain"
...
import zkBillProof from "./sample_proof/zkbill_proof.json"
import { Group } from "@semaphore-protocol/group"
import { generateProof } from "@semaphore-protocol/proof"
import { config } from "../package.json"

describe("ZkBill", async () => {
    ...
    beforeEach(async () => {
        ...
        const VerifierFactory = await ethers.getContractFactory("ZkBillVerifier")
        verifier = (await VerifierFactory.deploy()) as ZkBillVerifier
